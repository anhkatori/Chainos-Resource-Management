...
@section('content')
    <div class="page-title">
        {{ Form::open(['url' => '/admin/resource', 'method' => 'GET', 'id' => 'form-resource']) }}
        <div class="header">
        ...
        <div class="modal fade" id="project" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
            aria-hidden="true">
