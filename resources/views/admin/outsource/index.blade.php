...
@section('content')
    <div class="page-title">
        ...
        <div class="page_action">
            ...
            <button class="add" style="width:180px " type="button" data-toggle="modal" data-target="#outsource">Thêm chi phí thuê ngoài</button>
        </div>
        <div class="table_box">
            <table class="table">
                <thead>
    ...
    <div class="modal fade" id="outsource" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
