...
<head>
    ...
    <!-- Toast -->
    <link rel="stylesheet"
        href="https://www.jqueryscript.net/demo/Toast-Notification-Bootstrap-jQuery-Bootoast/bootoast.css">
    <!--  Weather  -->
    ...
    <link href="{{ asset('assets/css/role.css') }}" rel="stylesheet" type="text/css">
    <link href="{{ asset('assets/css/permission.css') }}" rel="stylesheet" type="text/css">
</head>
...
<body class="" style="background-color: #F0F2F5; overflow: auto; scrollbar-width: thin;">
    ...
    <script type="text/javascript"
        src="https://www.jqueryscript.net/demo/Toast-Notification-Bootstrap-jQuery-Bootoast/bootoast.js"></script>
